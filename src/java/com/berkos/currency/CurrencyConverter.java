    ...
    private double isotimia;
      ...
      public  void readxml() {
        try {
            ...
            String stringNo= attrCurr[2].toString();
...
*/
    ...
    /*  
   public  static void antonis (HttpServletRequest request, HttpServletResponse response)
    throws ServletException, IOException {

        //Redirect call to another url
        response.sendRedirect("http://www.inf.uth.gr");
    }
    ...
    public void doPost(HttpServletRequest req,
          ...
          // readxml(); // me ayton ton tropo arxikopoioume ta orismata!
           ...
           if(method.equals("redirect")){
               res.sendRedirect("http://dl.dropbox.com/u/12925667/project1_WWW_Berkakis.rar");
               return;
           } 
           ...
           out.println("<html>");
           out.println("<head><title>Currency Conversion by Antonis</title> <link rel=\"stylesheet\" type=\"text/css\" href=\"grafika.css\" /> </head>");
           out.println("<body>");
         ...
         try {
            ...
            for (int k = 0; k < attrName.length; k++) {
                 ...
                 if(attrName[k].toString().contains(value)){
